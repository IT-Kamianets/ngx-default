...
Pievienojot vai atjauninot tulkojumus:

- uzturiet valodu kodus saskaņotus ar `LanguageCode`
- atjauniniet `LANGUAGES`, pievienojot vai pārsaucot atbalstītu valodu
- glabājiet tulkojumu tekstu un valodu nosaukumus kā īstus UTF-8 simbolus, nevis escaped vai nepareizi pārkodētu tekstu
- saglabājiet angļu avota virknes stabilas, ja vien neplānojat atjaunināt katru tulkojuma ierakstu
