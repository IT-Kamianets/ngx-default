...
UI translations sijaitsevat tällä hetkellä tiedostossa:

```text
src/app/app.translates.ts
```

Kielimetatiedot sijaitsevat tiedostoissa:
...
Kun lisäät tai päivität translations:

- pidä language codes linjassa `LanguageCode`-määrittelyn kanssa
- päivitä `LANGUAGES`, kun lisäät tai nimeät uudelleen tuetun kielen
- tallenna translation text ja language labels oikeina UTF-8-merkkeinä, ei escaped- tai uudelleenkoodattuna mojibake-muotona
- pidä English source strings vakaina, ellei tarkoituksesi ole päivittää jokaista translation entryä
