...
När översättningar läggs till eller uppdateras:

- håll språkkoder i linje med `LanguageCode`
- uppdatera `LANGUAGES` när ett språk läggs till eller byter namn
- lagra översättningstext och språketiketter som riktiga UTF-8-tecken, inte escaped eller felkodad mojibake
- håll engelska källsträngar stabila om du inte tänker uppdatera varje översättningspost
