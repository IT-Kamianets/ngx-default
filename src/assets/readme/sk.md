# Angular šablóna pre landing page (SSR + Prerender)
...
# Spustenie SSR servera (voliteľné)
...
## Feature štruktúra pre moduly napojené na back-end
...
# Vytvorenie nového projektu z tejto šablóny
...
## Inicializácia vlastného git repository
