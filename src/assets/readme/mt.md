...
Il-metadata tal-lingwi tinsab f':
...
Meta żżid jew taġġorna t-traduzzjonijiet:

- żomm il-language codes allinjati ma' `LanguageCode`
- aġġorna `LANGUAGES` meta żżid jew tibdel l-isem ta' lingwa appoġġata
- aħżen it-test tat-traduzzjoni u l-labels tal-lingwi bħala karattri UTF-8 veri, mhux escaped jew mojibake re-encoded
- żomm l-English source strings stabbli sakemm ma jkollokx il-ħsieb li taġġorna kull translation entry
