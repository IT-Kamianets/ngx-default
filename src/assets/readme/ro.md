...
Metadatele limbilor se află în:
...
Când adaugi sau actualizezi traduceri:

- păstrează codurile de limbă aliniate cu `LanguageCode`
- actualizează `LANGUAGES` când adaugi sau redenumești o limbă suportată
- stochează textele traduse și etichetele limbilor ca caractere UTF-8 reale, nu escape-uite sau
  re-encodate greșit
- păstrează stabile șirurile sursă în engleză, cu excepția cazului în care intenționezi să
  actualizezi fiecare intrare de traducere
