...
UI translations findes i øjeblikket i:

```text
src/app/app.translates.ts
```

Sprogmetadata findes i:
...
Når du tilføjer eller opdaterer translations:

- hold language codes på linje med `LanguageCode`
- opdater `LANGUAGES`, når du tilføjer eller omdøber et understøttet sprog
- gem translation text og language labels som rigtige UTF-8-tegn, ikke escaped eller genkodet mojibake
- hold English source strings stabile, medmindre du vil opdatere hver translation entry
