...
UI translations наразі розміщені в:

```text
src/app/app.translates.ts
```

Метадані мов розміщені в:
...
Під час додавання або оновлення translations:

- тримайте language codes узгодженими з `LanguageCode`
- оновлюйте `LANGUAGES`, коли додаєте або перейменовуєте підтримувану мову
- зберігайте translation text і language labels як справжні UTF-8 символи, а не escaped або повторно закодований mojibake
- тримайте English source strings стабільними, якщо не плануєте оновити кожен translation entry
