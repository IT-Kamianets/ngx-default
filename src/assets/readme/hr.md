...
Kada dodajete ili ažurirate translations:

- držite language codes usklađenima s `LanguageCode`
- ažurirajte `LANGUAGES` kada dodajete ili preimenujete podržani jezik
- čuvajte translation text i language labels kao stvarne UTF-8 znakove, a ne escaped ili ponovno kodirani mojibake
- držite English source strings stabilnima ako ne planirate ažurirati svaki translation entry
